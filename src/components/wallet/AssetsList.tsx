        ...
        <Table className="min-w-[650px]">
          <TableHeader className="bg-muted/10">
            <TableRow className="hover:bg-transparent border-none">
              <TableHead className="w-[300px] text-[10px] font-bold uppercase tracking-widest px-6 h-9">
                Ativo / Identificador
              </TableHead>
              <TableHead className="text-[10px] font-bold uppercase tracking-widest px-6 h-9">
                Status Blockchain
              </TableHead>
              <TableHead className="text-right text-[10px] font-bold uppercase tracking-widest px-6 h-9">
                Volume Total
              </TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {loading ? (
                  ...
                  <div className="flex flex-col items-center justify-center space-y-2 opacity-60">
                    ...
                    <div className="space-y-0.5">
                      ...
                      <p className="text-[10px] text-muted-foreground font-medium max-w-[280px]">
                        Os ativos aparecerão aqui assim que o período de garantia expirar.
                      </p>
                    </div>
                  </div>
                </TableCell>
              ...
              assetEntries.map(([assetAddress, amount]) => (
                <TableRow
                  key={assetAddress}
                  className="group border-muted/30 hover:bg-muted/[0.02] transition-colors"
                >
                  ...
                  <TableCell className="px-6">
                    <Badge
                      variant="outline"
                      className="text-[9px] h-5 font-bold border-emerald-500/30 bg-emerald-500/[0.05] text-emerald-600 px-2 uppercase tracking-tight shadow-none rounded-md"
                    >
                      Livre para Resgate
                    </Badge>
                  </TableCell>
